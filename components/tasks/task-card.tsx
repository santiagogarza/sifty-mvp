...
export const TaskCard = React.memo(
  React.forwardRef<HTMLDivElement, TaskCardProps>(function TaskCard(props, ref) {
    if (props.isOverlay) {
      return <TaskCardView {...props} ref={ref} />;
    }
    return <DraggableTaskCard {...props} ref={ref} />;
  }),
);

const DraggableTaskCard = React.forwardRef<HTMLDivElement, TaskCardProps>(
  function DraggableTaskCard(props, ref) {
...
const TaskCardView = React.forwardRef<
  HTMLDivElement,
  TaskCardProps & {
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-1">
          ...
          {task.nextAction && !isDone ? (
            <div className="text-[12px] text-[var(--fg-muted)] line-clamp-2">{task.nextAction}</div>
          ) : null}
        </div>
